...
### Fixed
- **subscription:** read the newest capped tail of oversized Claude transcript files instead of their oldest prefix, preserving current-window and weighted token usage while discarding only an initial partial JSONL record.
