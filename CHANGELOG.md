...
### Fixed
- **memory/direct-mem0:** capture background save outcomes as tasks finish, retain only the newest 1,000 results for up to one hour, and flush accepted writes before closing storage resources so fire-and-forget saves cannot leak indefinitely or race shutdown.
