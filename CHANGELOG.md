...
### Fixed
- **proxy/factory:** route Droid's OpenAI Responses traffic through the Responses handler instead of generic passthrough, preserving the configured Factory upstream and query while enabling compression, output shaping, and Factory-attributed request metrics.
