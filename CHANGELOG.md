...
### Features
- **dashboard/co2:** add a CO2 Saved card to the proxy dashboard and `/stats` endpoint. Compression sessions now surface an estimated carbon footprint reduction alongside token and cost savings, using EcoLogits-style energy-per-token constants with the IEA 2023 global average carbon intensity.
