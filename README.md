...
- **Agent wrap** — `headroom wrap claude|codex|copilot|cursor|aider|grok|opencode|cline|continue|goose|openhands|openclaw|vibe` in one command; undo with `headroom unwrap <tool>`
