...
@click.option(
    "--retry-base-delay-ms",
    type=click.IntRange(min=0, max=600000),
    default=None,
    envvar="HEADROOM_RETRY_BASE_DELAY_MS",
    help=(
        "Base upstream retry delay in milliseconds (0–600000, default: 1000). "
...
@click.option(
    ...
    help=(
        "Maximum upstream retry delay in milliseconds (0–600000, default: 30000). "
