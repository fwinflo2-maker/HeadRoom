...
def goose(
    ...
    Goose's API calls through Headroom. Sets up the selected CLI context tool
    by injecting RTK guidance into .goosehints at the project root (Goose reads
    this file as extra system context).
