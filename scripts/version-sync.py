...
def main() -> None:
    ...
    update_package_json(args.root / "integrations/pi-extension/package.json", version)
    update_package_lock(args.root / "integrations/pi-extension/package-lock.json", version)
    update_plugin_versions(args.root, version)
