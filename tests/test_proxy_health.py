...
@pytest.mark.parametrize(
    ...
    [
        (
            ...
            None,
            False,
            {"enabled": True, "ready": False, "status": "degraded", "optional": True, "backend": None},
        ),
        (
            "null",
            _ReadyCompressor(),
            False,
            {"enabled": True, "ready": True, "status": "healthy", "optional": True, "backend": "onnx"},
        ),
        (
            "null",
            _ReadyCompressor(backend="remote"),
            False,
            {"enabled": True, "ready": True, "status": "healthy", "optional": True, "backend": "remote"},
        ),
        (
            "error",
            _ReadyCompressor(),
        ...
        (
            ...
            _ReadyCompressor(),
            False,
            {"enabled": True, "ready": True, "status": "healthy", "optional": True, "backend": "existing"},
        ),
        (
            "null",
            _ReadyCompressor(),
            True,
            {"enabled": False, "ready": True, "status": "disabled", "optional": True, "backend": None},
        ),
    ],
)
